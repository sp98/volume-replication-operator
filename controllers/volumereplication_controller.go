...
func (r *VolumeReplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		_ = r.updateReplicationStatus(instance, err.Error())
	...
	case replicationv1alpha1.Secondary:
		...
		if replicationErr == nil {
			err := r.updateReplicationStatus(instance, "volume is marked secondary")
			if err != nil {
				return ctrl.Result{}, err
			}
	...
	default:
		...
		setFailureCondition(instance)
		_ = r.updateReplicationStatus(instance, replicationErr.Error())
		return ctrl.Result{}, nil
	}
	...
	if requeueForResync {
		...
		_ = r.updateReplicationStatus(instance, "volume is degraded")
	...
	err = r.updateReplicationStatus(instance, msg)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *VolumeReplicationReconciler) updateReplicationStatus(instance *replicationv1alpha1.VolumeReplication, message string) error {
	instance.Status.State = getReplicationState(instance)
