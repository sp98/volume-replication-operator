...
// sets conditions when image was promoted successfully
...
// sets conditions when image promotion was failed
...
// sets conditions when image was demoted successfully
...
// sets conditions when image demotion was failed
...
// sets conditions when image resync was triggered successfully
...
// sets conditions when image is not ready to use
func setDegradedCondition(conditions *[]metav1.Condition, observedGeneration int64) {
	setStatusCondition(conditions, metav1.Condition{
		Type:               ConditionDegraded,
		Reason:             ImageDegraded,
		ObservedGeneration: observedGeneration,
		Status:             metav1.ConditionTrue,
	})
}

// sets conditions when image resync failed
